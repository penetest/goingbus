...
function getCollectedByKeyName(keyName) {
  return getDataByKey(storageKey.collected, keyName);
}
...
function getRecentlyByKeyName(keyName) {
  return getDataByKey(storageKey.recently, keyName);
}
...
// 是否使用
function hasRecently(keyName) {
  return hasKey(storageKey.recently, keyName);
}
...
module.exports = {
  getCollectedByKeyName,
  getCollected,
  getRecentlyByKeyName,
  getRecently,
  hasCollected,
  hasRecently,
  addCollected,
